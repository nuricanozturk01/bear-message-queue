import {
  Graph,
  clone_default
} from "./chunk-VCWCF33Y.js";
import "./chunk-VBM6H7VM.js";
import {
  getLineFunctionsWithOffset
} from "./chunk-CQACGIWK.js";
import {
  getSubGraphTitleMargins
} from "./chunk-UDFVLOM5.js";
import {
  createText,
...
var labelHelper = __name((parent, node, _classes, isNode) => __async(null, null, function* () {
  const config2 = getConfig2();
  let classes2;
...
var note = __name((parent, node) => __async(null, null, function* () {
...
var question = __name((parent, node) => __async(null, null, function* () {
...
var hexagon = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var block_arrow = __name((parent, node) => __async(null, null, function* () {
...
var rect_left_inv_arrow = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var lean_right = __name((parent, node) => __async(null, null, function* () {
...
var lean_left = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var trapezoid = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var inv_trapezoid = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect_right_inv_arrow = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var cylinder = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
...
var composite = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    "node " + node.classes,
...
var labelRect = __name((parent, node) => __async(null, null, function* () {
...
var stadium = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var circle2 = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var doublecircle = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox, halfPadding } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var subroutine = __name((parent, node) => __async(null, null, function* () {
  const { shapeSvg, bbox } = yield labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var nodeElems = {};
var insertNode = __name((elem, node, renderOptions) => __async(null, null, function* () {
  let newEl;
  let el;
  if (node.link) {
    let target;
...
//# sourceMappingURL=blockDiagram-XN6IQ5JY-DFLWVZV6.js.map

...
var createText = __name((_0, ..._1) => __async(null, [_0, ..._1], function* (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
  ...
  if (useHtmlLabels) {
    ...
    const vertexNode = yield addHtmlSpan(el, node, width, classes, addSvgBackground);
    return vertexNode;
  } else {
...
//# sourceMappingURL=chunk-D53MVTJ2.js.map

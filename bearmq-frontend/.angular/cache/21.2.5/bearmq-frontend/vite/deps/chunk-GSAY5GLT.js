...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-P27NXTFD.mjs
...
var calculateMathMLDimensions = __name((text2, config2) => __async(null, null, function* () {
  text2 = yield renderKatex(text2, config2);
...
var renderKatex = __name((text2, config2) => __async(null, null, function* () {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  const { default: katex } = yield import("./katex-GGVFS53X.js");
...
//# sourceMappingURL=chunk-GSAY5GLT.js.map

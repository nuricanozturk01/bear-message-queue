...
var insertEdgeLabel = __name((elem, edge) => __async(null, null, function* () {
  ...
  if (edge.endLabelLeft) {
    const endLabelElement = yield createLabel_default(edge.endLabelLeft, getLabelStyles(edge.labelStyle));
  ...
  if (edge.endLabelRight) {
    const endLabelElement = yield createLabel_default(edge.endLabelRight, getLabelStyles(edge.labelStyle));
...
//# sourceMappingURL=chunk-O27ZXGXO.js.map

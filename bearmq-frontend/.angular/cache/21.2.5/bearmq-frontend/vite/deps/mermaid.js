...
import {
  JSON_SCHEMA,
  load
} from "./chunk-EIQIQ6W2.js";
import {
  registerLayoutLoaders
} from "./chunk-CJVXW2U5.js";
import "./chunk-O27ZXGXO.js";
import "./chunk-66JO2TML.js";
import "./chunk-CQACGIWK.js";
import "./chunk-UDFVLOM5.js";
import {
  registerIconPacks
} from "./chunk-MYWUPHTO.js";
import {
  dedent
} from "./chunk-D53MVTJ2.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import "./chunk-GEHQIUC3.js";
import "./chunk-OHMBLUAF.js";
import {
  UnknownDiagramError,
  __name,
  addDirective,
...
var loader = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./c4Diagram-GPMAACGM-6ITZHCRN.js");
...
var loader2 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-TSWR6T2D-NXLMAIFZ.js");
...
var loader3 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-TSWR6T2D-NXLMAIFZ.js");
...
var loader4 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./erDiagram-WO52GFNT-YJBZWJKW.js");
...
var loader5 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./gitGraphDiagram-5C7YHVU6-54JZZ36Y.js");
...
var loader6 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./ganttDiagram-FAOCOTIY-G44RCC3B.js");
...
var loader7 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./infoDiagram-P5D6MX3V-Y4BS7ZZA.js");
...
var loader8 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./pieDiagram-BLWKPB35-3UDC6JIB.js");
...
var loader9 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./quadrantDiagram-QXWEEFXS-FWH5CGR4.js");
...
var loader10 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./xychartDiagram-MYLB5AYS-KUT34R2H.js");
...
var loader11 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./requirementDiagram-XAUNFCZY-7KL734NK.js");
...
var loader12 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./sequenceDiagram-D25TJ2OB-3RMB62RD.js");
...
var loader13 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-FEGYTUDG-DKWSCAS7.js");
...
var loader14 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-v2-R65JCUOM-ST5HVWB7.js");
...
var loader15 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-GNSP7T6Y-LQ47L3E6.js");
...
var loader16 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-v2-HP6YRVRG-244KHEW3.js");
...
var loader17 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./journeyDiagram-UIGPPNLY-OCSAIX46.js");
...
var loader18 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-TSWR6T2D-NXLMAIFZ.js");
...
var loader19 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./timeline-definition-27KQCCZ3-SONZLKDR.js");
...
var loader20 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./mindmap-definition-R7LC4OIY-BJLTZZDS.js");
...
var loader21 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./kanban-definition-KMT3NSR2-7PUPBBTD.js");
...
var loader22 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./sankeyDiagram-LVV36NHA-FXNG2BBS.js");
...
var loader23 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-NZMEDLQF-EPINI4L3.js");
...
var loader24 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./blockDiagram-XN6IQ5JY-DFLWVZV6.js");
...
var loader25 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./architectureDiagram-AYX4OTIS-O3HXPJ3Q.js");
...
var loadRegisteredDiagrams = __name(() => __async(null, null, function* () {
  log.debug(`Loading registered diagrams`);
  const results = yield Promise.allSettled(
    Object.entries(detectors).map((_0) => __async(null, [_0], function* ([key, { detector: detector26, loader: loader26 }]) {
      if (loader26) {
        try {
          getDiagram(key);
        } catch (e) {
          try {
            const { diagram: diagram2, id: id26 } = yield loader26();
...
var Diagram = class _Diagram {
  ...
  static fromText(_0) {
    return __async(this, arguments, function* (text, metadata = {}) {
      ...
      try {
        ...
        const { id: id26, diagram: diagram2 } = yield loader26();
  ...
  render(id26, version2) {
    return __async(this, null, function* () {
      yield this.renderer.draw(this.text, id26, version2, this);
    });
  }
  getParser() {
    return this.parser;
...
var render = __name(function(id26, text, svgContainingElement) {
  return __async(this, null, function* () {
    addDiagrams();
    ...
    try {
      yield diag.renderer.draw(text, id26, version, diag);
    } catch (e) {
      if (config.suppressErrorRendering) {
        removeTempElements();
      } else {
...
var runThrowsErrors = __name(function() {
  return __async(this, arguments, function* ({ postRenderCallback, querySelector, nodes } = {
    ...
    for (const element of Array.from(nodesToProcess)) {
      ...
      try {
        const { svg, bindFunctions } = yield render2(id26, txt, element);
        element.innerHTML = svg;
        if (postRenderCallback) {
          yield postRenderCallback(id26);
        }
        if (bindFunctions) {
...
var registerExternalDiagrams = __name((_0, ..._1) => __async(null, [_0, ..._1], function* (diagrams, {
  lazyLoad = true
} = {}) {
  addDiagrams();
...
var executeQueue = __name(() => __async(null, null, function* () {
...
var parse22 = __name((text, parseOptions) => __async(null, null, function* () {

...
var drawNode = __name(function(db2, elem, node, fullSection, conf) {
...
function drawNodes(db2, svg, mindmap, section, conf) {
  return __async(this, null, function* () {
    yield drawNode(db2, svg, mindmap, section, conf);
    if (mindmap.children) {
      yield Promise.all(
...
var draw = __name((text, id, _version, diagObj) => __async(null, null, function* () {
  ...
  yield drawNodes(db2, nodesElem, mm, -1, conf);
  const cy = yield layoutMindmap(mm, conf);
...
//# sourceMappingURL=mindmap-definition-R7LC4OIY-BJLTZZDS.js.map

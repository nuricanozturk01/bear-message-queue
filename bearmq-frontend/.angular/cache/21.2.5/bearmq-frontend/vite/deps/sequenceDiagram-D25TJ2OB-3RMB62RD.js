...
var drawKatex = __name(function(elem, textData, msgModel = null) {
  return __async(this, null, function* () {
    ...
    const lines = yield renderKatex(textData.text, getConfig());
...
var drawActor = __name(function(elem, actor, conf2, isFooter) {
  return __async(this, null, function* () {
    switch (actor.type) {
      case "actor":
        return yield drawActorTypeActor(elem, actor, conf2, isFooter);
      case "participant":
        return yield drawActorTypeParticipant(elem, actor, conf2, isFooter);
    }
  });
}, "drawActor");
...
var drawLoop = __name(function(elem, loopModel, labelText, conf2) {
  return __async(this, null, function* () {
    const {
      boxMargin,
      boxTextMargin,
...
var _drawTextCandidateFunc = (function() {
  ...
  function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    return __async(this, null, function* () {
      ...
      text.append("div").style("text-align", "center").style("vertical-align", "middle").html(yield renderKatex(content, getConfig()));
      byTspan(content, s, x, y, width, height, textAttrs, conf2);
      _setTextAttrs(text, textAttrs);
    });
  }
...
var drawNote = __name(function(elem, noteModel) {
  return __async(this, null, function* () {
...
var drawMessage = __name(function(diagram2, msgModel, lineStartY, diagObj) {
  return __async(this, null, function* () {
...
var drawActors = __name(function(diagram2, actors, actorKeys, isFooter) {
  return __async(this, null, function* () {
    if (!isFooter) {
      for (const actorKey of actorKeys) {
        const actor = actors.get(actorKey);
        yield svgDraw_default.drawActor(diagram2, actor, conf, false);
      }
    } else {
      let maxHeight = 0;
      ...
      for (const actorKey of actorKeys) {
        ...
        const height = yield svgDraw_default.drawActor(diagram2, actor, conf, true);
...
var draw = __name(function(_text, id, _version, diagObj) {
  return __async(this, null, function* () {
    ...
    for (const msg of messages) {
      ...
      switch (msg.type) {
        case diagObj.db.LINETYPE.NOTE:
          ...
          yield drawNote(diagram2, noteModel);
          break;
        ...
        case diagObj.db.LINETYPE.LOOP_END:
          ...
          yield svgDraw_default.drawLoop(diagram2, loopModel, "loop", conf);
        ...
        case diagObj.db.LINETYPE.OPT_END:
          loopModel = bounds.endLoop();
          yield svgDraw_default.drawLoop(diagram2, loopModel, "opt", conf);
          bounds.bumpVerticalPos(loopModel.stopy - bounds.getVerticalPos());
          bounds.models.addLoop(loopModel);
          break;
        ...
        case diagObj.db.LINETYPE.ALT_END:
          loopModel = bounds.endLoop();
          yield svgDraw_default.drawLoop(diagram2, loopModel, "alt", conf);
          bounds.bumpVerticalPos(loopModel.stopy - bounds.getVerticalPos());
          bounds.models.addLoop(loopModel);
          break;
        ...
        case diagObj.db.LINETYPE.PAR_END:
          loopModel = bounds.endLoop();
          yield svgDraw_default.drawLoop(diagram2, loopModel, "par", conf);
          bounds.bumpVerticalPos(loopModel.stopy - bounds.getVerticalPos());
          bounds.models.addLoop(loopModel);
          break;
        ...
        case diagObj.db.LINETYPE.CRITICAL_END:
          loopModel = bounds.endLoop();
          yield svgDraw_default.drawLoop(diagram2, loopModel, "critical", conf);
          bounds.bumpVerticalPos(loopModel.stopy - bounds.getVerticalPos());
          bounds.models.addLoop(loopModel);
          break;
        ...
        case diagObj.db.LINETYPE.BREAK_END:
          loopModel = bounds.endLoop();
          yield svgDraw_default.drawLoop(diagram2, loopModel, "break", conf);
          bounds.bumpVerticalPos(loopModel.stopy - bounds.getVerticalPos());
          bounds.models.addLoop(loopModel);
          break;
        default:
    ...
    yield drawActors(diagram2, actors, actorKeys, false);
    for (const e of messagesToDraw) {
      yield drawMessage(diagram2, e.messageModel, e.lineStartY, diagObj);
    }
    if (conf.mirrorActors) {
      yield drawActors(diagram2, actors, actorKeys, true);
    }
...
//# sourceMappingURL=sequenceDiagram-D25TJ2OB-3RMB62RD.js.map

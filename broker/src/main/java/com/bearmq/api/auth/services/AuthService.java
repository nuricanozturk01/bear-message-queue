...
public class AuthService {
  ...
  public AuthResponse register(final RegisterRequest request) {
    ...
    final TenantAuthenticateInfo created = this.tenantService.create(request);
  ...
  private AuthResponse toAuthResponse(final TenantAuthenticateInfo info) {
    ...
    return this.authResponseMapper.toResponse(
        this.jwtTokenService.createAccessToken(info),
        this.jwtTokenService.createRefreshToken(info.id()),
        this.messagingApiKeyService.getMessagingApiKey());
  }
}
